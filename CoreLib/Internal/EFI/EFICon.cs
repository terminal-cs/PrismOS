...
namespace Internal.EFI
{
    ...
    [StructLayout(LayoutKind.Sequential)]
    public unsafe struct SimpleInputInterface
    {
        public readonly delegate* unmanaged<SimpleInputInterface*, bool, EfiStatus> Reset;
        public readonly delegate* unmanaged<SimpleInputInterface*, EfiInputKey*, EfiStatus> ReadKeyStroke;
